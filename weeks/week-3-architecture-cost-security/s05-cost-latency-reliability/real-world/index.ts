 ...
 *
 * Run it:       npm run lab weeks/week-3-architecture-cost-security/s05-cost-latency-reliability/real-world/index.ts
 * Guarded only: npm run lab weeks/week-3-architecture-cost-security/s05-cost-latency-reliability/real-world/index.ts --guarded
 */
import { z } from "zod";
