...
Part of [Week 3 · Agent Architecture, Cost and Security](..). The workshop slides are at
...
npm run lab weeks/week-3-architecture-cost-security/s06-budget-failure-map/review.ts
...
```bash
npm run lab weeks/week-3-architecture-cost-security/s06-budget-failure-map/review.ts
npm run lab weeks/week-3-architecture-cost-security/s06-budget-failure-map/review.ts --investigator
```
